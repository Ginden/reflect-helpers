...
( function (root, factory) {
    ...
    var getNaiveFunctionSourceCode = Function.prototype.call.bind(Function.toString);

    /*
     * SECTION: reference functions
     */
    /* istanbul ignore next */
    _R.__boundFunction = (function bound() {
    }).bind(null);
    /* istanbul ignore next */
    ...
    _R.indirectEval = function indirectEval(code) {
        return Function('delete arguments.length; return eval(arguments[0])').call(null, code);
    };
    ...
    _R.getFunctionSourceCode = function getFunctionSourceCode(func) {
        ...
        return Function.toString.call(func);
    };
    ...
    _R.construct = Reflect.construct;
    /**
