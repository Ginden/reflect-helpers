...
( function(root, factory) {
        ...
        _R.__createAccesor = function __createGetter(accesor, target, proxy, key) {
            return function accessor(){
                if (arguments.length === 0) {
                    return accesor.apply(this, [this, key, proxy]);
                } else {
                    return accesor.apply(this, [this, key, arguments[0], proxy]);
                }
            };
        };
        ...
        */
        ...
        _R.getObjectPropertiesNames = function getObjectPropertiesNames(what, searchInPrototypes) {
            ...
            if (searchInPrototypes) {
                keys.push.apply(keys, getObjectPropertiesNames(_R.getObjectPrototype(what), true));
            }
            return keys;
        };
        /*
